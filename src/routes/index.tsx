        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          <div className="mb-8">
            ...
            <p className="mt-1 text-muted-foreground">
              Browse every property on the left and see its exact location on the map.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_1.3fr]">
            ...
            <div
              className="max-h-[560px] overflow-y-auto rounded-xl border border-border bg-card p-2"
            ...
            <div className="flex flex-col gap-3">
              {selected && (
                <>
                  ...
                  <MapSection address={selected.address} title={selected.title} />
                </>
              )}
            </div>
          </div>
